...
The Disasters list provides access to disaster names and disaster types covered by [ReliefWeb](https://response.reliefweb.int/), humanitarianresponse.info, and Humanitarian ID since 1981.
