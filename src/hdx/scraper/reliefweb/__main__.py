...
from hdx.scraper.reliefweb._version import __version__
from hdx.scraper.reliefweb.pipeline import Pipeline

logger = logging.getLogger(__name__)

_LOOKUP = "hdx-scraper-reliefweb"
...
def main(
    ...
    with wheretostart_tempdir_batch(folder=_LOOKUP) as info:
        ...
        with Download() as downloader:
            ...
            disaster_list = pipeline.scrape_data()
            dataset = pipeline.generate_dataset(disaster_list=disaster_list)
            if dataset:
